...
domain_col_types <- cols(
  ...
  llms_txt_http_status = col_integer(),
  llms_txt_error_type = col_character(),
  llms_txt_request_attempts = col_integer(),
  robots_txt_status = col_character(),
  robots_txt_http_status = col_integer(),
  robots_txt_error_type = col_character(),
  robots_txt_request_attempts = col_integer(),
